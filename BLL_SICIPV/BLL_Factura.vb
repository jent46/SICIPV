...
Public Class BLL_Factura
    ...
    Shared Function ingresarBD(ByVal pfactura As ClsFactura, ByVal mensaje As String) As Boolean
        Return New DLL_Factura().ingresarBD(pfactura, mensaje)
    End Function

    Shared Function modificarBD(ByVal pfactura As ClsFactura, ByVal mensaje As String) As Boolean
